        ...
        {(() => {
          const default14Rules = [
            ...
            },
            {
              ...
              status: (scan?.parsed_fields?.consumer_care?.phone || scan?.parsed_fields?.consumer_care?.email) ? 'PASS' : 'FAIL',
            ...
            },
            {
              ...
              status: (scan?.parsed_fields?.storage_instructions?.is_declared || scan?.parsed_fields?.storage_instructions?.instructions) ? 'PASS' : 'FAIL',
            ...
            },
            {
              ...
              status: (typeof scan?.parsed_fields?.country_of_origin === 'object' && scan?.parsed_fields?.country_of_origin?.is_imported && (!scan?.parsed_fields?.country_of_origin?.country || scan?.parsed_fields?.country_of_origin?.country === 'Unspecified')) ? 'FAIL' : 'PASS',
